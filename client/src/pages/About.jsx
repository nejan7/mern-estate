  ...
  return (
    <div className="py-10 px-4 max-w-6xl mx-auto">
      <div className="max-w-4xl mx-auto mb-4">
        <img src={about} alt="AboutUs" className=""  />
      </div>
      <h1 className="text-3xl font-bold mb-4">About Negin Estate</h1>
      <p className="mb-4 text-slate-700">
        Negin Estate is a leading real estate agency that specializes in helping
